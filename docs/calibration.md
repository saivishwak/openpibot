...
6. **Step 5 — Wrist roll**: squeeze grip, keep it held, roll your wrist **RIGHT** by ~20-45°, then release. For both controllers, use the same physical intent: thumb side rolls to your right. Both wrist steps are required because live wrist teleop uses the captured controller-local pitch/roll axes directly.
